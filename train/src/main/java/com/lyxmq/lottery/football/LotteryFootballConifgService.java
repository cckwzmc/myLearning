...
public class LotteryFootballConifgService {
	...
	static {
		try {
			Properties pro = PropertiesLoaderUtils.loadAllProperties("lottery/football/lottery.properties");
			...
			www500wanFootballMedia = StringUtils.replace(dyjFootballUrl, "@footballExpect@", footballExpect);
