 ...
 * 
 */
public class ArticleBaseModel extends BaseObject {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6718558491585283407L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ArticleBaseModel other = (ArticleBaseModel) obj;
		if (arcRank == null) {
	...
	public String toString() {
		return "ArticleModel [id=" + id + ", typeId=" + typeId + ", typeId2=" + typeId2 + ", sortRank=" + sortRank + ", flag=" + flag + ", ismake=" + ismake + ", channel="
				+ channel + ", arcRank=" + arcRank + ", payMoney=" + payMoney + ", title=" + title + ", shorttitle=" + shorttitle + ", color=" + color + ", author=" + author
				+ ", source=" + source + ", litpic=" + litpic + ", pubDate=" + pubDate + ", createDate=" + createDate + ", mid=" + mid + ", keywords=" + keywords
				+ ", description=" + description + ", filename=" + filename + ", dutyadmin=" + dutyadmin + ", tackid=" + tackid + ", mtype=" + mtype + ", weight=" + weight + "]";
	}
