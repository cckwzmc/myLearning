...
import static com.toney.dal.constants.Constants.DEFAULT_PAGE_SIZE;
...
public class Page<T> {
	...
	public String toString() {
		return "Page [pageNo=" + pageNo + ", pageSize=" + pageSize
				...
				+ ", morePage=" + morePage + ", preMorePage=" + preMorePage
				+ ", showMinPage=" + showMinPage + ", showMaxPage="
				+ showMaxPage + ", result=" + result + ", isHasNext="
				+ isHasNext + ", isHasPre=" + isHasPre + ", firstRecord="
