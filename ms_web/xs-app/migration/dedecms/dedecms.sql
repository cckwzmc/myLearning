...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`dedecms` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `batch_job_execution`(`JOB_EXECUTION_ID`,`VERSION`,`JOB_INSTANCE_ID`,`CREATE_TIME`,`START_TIME`,`END_TIME`,`STATUS`,`EXIT_CODE`,`EXIT_MESSAGE`,`LAST_UPDATED`) values (1,2,1,'2012-10-11 18:39:00','2012-10-11 18:39:00','2012-10-11 18:39:00','FAILED','FAILED','org.springframework.batch.core.JobExecutionException: Flow execution ended unexpectedly\r\n	at org.springframework.batch.core.job.flow.FlowJob.doExecute(FlowJob.java:141)\r\n	at org.springframework.batch.core.job.AbstractJob.execute(AbstractJob.java:293)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher$1.run(SimpleJobLauncher.java:120)\r\n	at org.springframework.core.task.SyncTaskExecutor.execute(SyncTaskExecutor.java:48)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher.run(SimpleJobLauncher.java:114)\r\n	at com.toney.crawler.collection.jobs.CrawlerPageJobImpl.crawlerHome(CrawlerPageJobImpl.java:40)\r\n	at sun.reflect.GeneratedMethodAccessor34.invoke(Unknown Source)\r\n	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:25)\r\n	at java.lang.reflect.Method.invoke(Method.java:597)\r\n	at org.springframework.util.MethodInvoker.invoke(MethodInvoker.java:273)\r\n	at org.springframework.scheduling.quartz.MethodInvokingJobDetailFactoryBean$MethodInvokingJob.executeInternal(MethodInvokingJobDetailFactoryBean.java:311)\r\n	at org.springframework.scheduling.quartz.QuartzJobBean.execute(QuartzJobBean.java:113)\r\n	at org.quartz.core.JobRunShell.run(JobRunShell.java:213)\r\n	at org.quartz.simpl.SimpleThreadPool$WorkerThread.run(SimpleThreadPool.java:557)\r\nCaused by: org.springframework.batch.core.job.flow.FlowExecutionException: Ended flow=crawlerHomeTaskExecutionJob at state=crawlerHomeTaskExecutionJob.crawlerHomeTaskExecutionStep with exception\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.resume(SimpleFlow.java:152)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.start(SimpleFlow.java:124)\r\n	at org.springframework.batch.core.job.flow.FlowJob.doExecute(FlowJob.java:135)\r\n	... 13 more\r\nCaused by: org.springframework.jdbc.BadSqlGrammarException: PreparedStatementCallback; bad SQL grammar [INSERT INTO BATCH_STEP_EXECUTION_CONTEXT (SHORT_CONTEXT, SERIALIZED_CONTEXT, STEP_EXECUTION_ID) VALUES(?, ?, ?)]; nested exception is com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException: Table \'dedecms.batch_step_execution_context\' doesn\'t exist\r\n	at org.springframework.jdbc.support.SQLErrorCodeSQLExceptionTranslator.doTranslate(SQLErrorCodeSQLExceptionTranslator.java:233)\r\n	at org.springframework.jdbc.support.AbstractFallbackSQLExceptionTranslator.translate(AbstractFallbackSQLExceptionTranslator.java:72)\r\n	at org.springframework.jdbc.core.JdbcTemplate.execute(JdbcTemplate.java:603)\r\n	at org.spr','2012-10-11 18:39:00'),(2,2,1,'2012-10-11 18:40:00','2012-10-11 18:40:00','2012-10-11 18:40:00','FAILED','FAILED','','2012-10-11 18:40:00'),(3,2,1,'2012-10-11 18:41:00','2012-10-11 18:41:00','2012-10-11 18:41:00','FAILED','FAILED','','2012-10-11 18:41:00'),(4,2,1,'2012-10-11 18:42:00','2012-10-11 18:42:00','2012-10-11 18:42:00','FAILED','FAILED','','2012-10-11 18:42:00'),(5,2,1,'2012-10-11 18:43:00','2012-10-11 18:43:00','2012-10-11 18:43:00','FAILED','FAILED','','2012-10-11 18:43:00'),(6,2,1,'2012-10-11 18:44:00','2012-10-11 18:44:00','2012-10-11 18:44:00','FAILED','FAILED','','2012-10-11 18:44:00'),(7,2,1,'2012-10-12 00:44:13','2012-10-12 00:44:17','2012-10-12 00:44:19','FAILED','FAILED','','2012-10-12 00:44:19'),(8,2,1,'2012-10-12 08:59:36','2012-10-12 08:59:39','2012-10-12 08:59:50','FAILED','FAILED','','2012-10-12 08:59:50'),(9,2,1,'2012-10-12 08:59:50','2012-10-12 08:59:51','2012-10-12 08:59:53','FAILED','FAILED','','2012-10-12 08:59:53'),(10,2,1,'2012-10-12 09:00:00','2012-10-12 09:00:00','2012-10-12 09:00:00','FAILED','FAILED','','2012-10-12 09:00:00'),(11,2,1,'2012-10-12 09:01:00','2012-10-12 09:01:00','2012-10-12 09:01:00','FAILED','FAILED','','2012-10-12 09:01:00'),(12,2,1,'2012-10-12 09:02:00','2012-10-12 09:02:00','2012-10-12 09:02:00','FAILED','FAILED','','2012-10-12 09:02:00'),(13,2,1,'2012-10-12 09:03:00','2012-10-12 09:03:00','2012-10-12 09:03:00','FAILED','FAILED','','2012-10-12 09:03:00');
...
insert  into `batch_job_execution_context`(`JOB_EXECUTION_ID`,`SHORT_CONTEXT`,`SERIALIZED_CONTEXT`) values (1,'{\"map\":\"\"}',NULL),(2,'{\"map\":\"\"}',NULL),(3,'{\"map\":\"\"}',NULL),(4,'{\"map\":\"\"}',NULL),(5,'{\"map\":\"\"}',NULL),(6,'{\"map\":\"\"}',NULL),(7,'{\"map\":\"\"}',NULL),(8,'{\"map\":\"\"}',NULL),(9,'{\"map\":\"\"}',NULL),(10,'{\"map\":\"\"}',NULL),(11,'{\"map\":\"\"}',NULL),(12,'{\"map\":\"\"}',NULL),(13,'{\"map\":\"\"}',NULL);
...
insert  into `batch_job_execution_seq`(`ID`) values (13);
...
insert  into `batch_job_instance`(`JOB_INSTANCE_ID`,`VERSION`,`JOB_NAME`,`JOB_KEY`) values (1,0,'crawlerHomeTaskExecutionJob','d41d8cd98f00b204e9800998ecf8427e');
...
insert  into `batch_step_execution`(`STEP_EXECUTION_ID`,`VERSION`,`STEP_NAME`,`JOB_EXECUTION_ID`,`START_TIME`,`END_TIME`,`STATUS`,`COMMIT_COUNT`,`READ_COUNT`,`FILTER_COUNT`,`WRITE_COUNT`,`READ_SKIP_COUNT`,`WRITE_SKIP_COUNT`,`PROCESS_SKIP_COUNT`,`ROLLBACK_COUNT`,`EXIT_CODE`,`EXIT_MESSAGE`,`LAST_UPDATED`) values (1,3,'crawlerHomeTaskExecutionStep',2,'2012-10-11 18:40:00','2012-10-11 18:40:00','FAILED',1,0,0,0,0,0,0,4,'FAILED','org.springframework.jdbc.BadSqlGrammarException: StatementCallback; bad SQL grammar [SELECT t.cid,t.sitename siteName,t.url,t.description,t.createdate createDate,t.listwords listWords,t.stopwords stopWords,t.isenable isEnable FROM dede_crawler_task t where t.enable=1 ORDER BY createdate desc ASC LIMIT 1]; nested exception is com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'ASC LIMIT 1\' at line 1\r\n	at org.springframework.jdbc.support.SQLErrorCodeSQLExceptionTranslator.doTranslate(SQLErrorCodeSQLExceptionTranslator.java:233)\r\n	at org.springframework.jdbc.support.AbstractFallbackSQLExceptionTranslator.translate(AbstractFallbackSQLExceptionTranslator.java:72)\r\n	at org.springframework.jdbc.core.JdbcTemplate.execute(JdbcTemplate.java:407)\r\n	at org.springframework.jdbc.core.JdbcTemplate.query(JdbcTemplate.java:456)\r\n	at org.springframework.jdbc.core.JdbcTemplate.query(JdbcTemplate.java:464)\r\n	at org.springframework.batch.item.database.JdbcPagingItemReader.doReadPage(JdbcPagingItemReader.java:208)\r\n	at org.springframework.batch.item.database.AbstractPagingItemReader.doRead(AbstractPagingItemReader.java:107)\r\n	at org.springframework.batch.item.support.AbstractItemCountingItemStreamItemReader.read(AbstractItemCountingItemStreamItemReader.java:85)\r\n	at org.springframework.batch.core.step.item.SimpleChunkProvider.doRead(SimpleChunkProvider.java:90)\r\n	at org.springframework.batch.core.step.item.SimpleChunkProvider.read(SimpleChunkProvider.java:150)\r\n	at org.springframework.batch.core.step.item.SimpleChunkProvider$1.doInIteration(SimpleChunkProvider.java:110)\r\n	at org.springframework.batch.repeat.support.RepeatTemplate.getNextResult(RepeatTemplate.java:367)\r\n	at org.springframework.batch.repeat.support.RepeatTemplate.executeInternal(RepeatTemplate.java:214)\r\n	at org.springframework.batch.repeat.support.RepeatTemplate.iterate(RepeatTemplate.java:143)\r\n	at org.springframework.batch.core.step.item.SimpleChunkProvider.provide(SimpleChunkProvider.java:105)\r\n	at org.springframework.batch.core.step.item.ChunkOrientedTasklet.execute(ChunkOrientedTasklet.java:68)\r\n	at org.springframework.batch.core.step.tasklet.TaskletStep$ChunkTransactionCallback.doInTransaction(TaskletStep.java:386)\r\n	at org.springframework.transaction.support.TransactionTemplate.execute(TransactionTemplate.java:130)\r\n	at org.springframework.batch.core.step.tasklet.Ta','2012-10-11 18:40:00'),(2,2,'crawlerHomeTaskExecutionStep',3,'2012-10-11 18:41:00','2012-10-11 18:41:00','FAILED',0,0,0,0,0,0,0,0,'FAILED','org.springframework.batch.item.ItemStreamException: Could not move to stored position on restart\r\n	at org.springframework.batch.item.support.AbstractItemCountingItemStreamItemReader.open(AbstractItemCountingItemStreamItemReader.java:155)\r\n	at org.springframework.batch.item.database.JdbcPagingItemReader.open(JdbcPagingItemReader.java:245)\r\n	at org.springframework.batch.item.support.CompositeItemStream.open(CompositeItemStream.java:93)\r\n	at org.springframework.batch.core.step.tasklet.TaskletStep.open(TaskletStep.java:301)\r\n	at org.springframework.batch.core.step.AbstractStep.execute(AbstractStep.java:192)\r\n	at org.springframework.batch.core.job.SimpleStepHandler.handleStep(SimpleStepHandler.java:135)\r\n	at org.springframework.batch.core.job.flow.JobFlowExecutor.executeStep(JobFlowExecutor.java:61)\r\n	at org.springframework.batch.core.job.flow.support.state.StepState.handle(StepState.java:60)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.resume(SimpleFlow.java:144)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.start(SimpleFlow.java:124)\r\n	at org.springframework.batch.core.job.flow.FlowJob.doExecute(FlowJob.java:135)\r\n	at org.springframework.batch.core.job.AbstractJob.execute(AbstractJob.java:293)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher$1.run(SimpleJobLauncher.java:120)\r\n	at org.springframework.core.task.SyncTaskExecutor.execute(SyncTaskExecutor.java:48)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher.run(SimpleJobLauncher.java:114)\r\n	at com.toney.crawler.collection.jobs.CrawlerPageJobImpl.crawlerHome(CrawlerPageJobImpl.java:40)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:39)\r\n	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:25)\r\n	at java.lang.reflect.Method.invoke(Method.java:597)\r\n	at org.springframework.util.MethodInvoker.invoke(MethodInvoker.java:273)\r\n	at org.springframework.scheduling.quartz.MethodInvokingJobDetailFactoryBean$MethodInvokingJob.executeInternal(MethodInvokingJobDetailFactoryBean.java:311)\r\n	at org.springframework.scheduling.quartz.QuartzJobBean.execute(QuartzJobBean.java:113)\r\n	at org.quartz.core.JobRunShell.run(JobRunShell.java:213)\r\n	at org.quartz.simpl.SimpleThreadPool$WorkerThread.run(SimpleThreadPool.java:557)\r\nCaused by: org.springframework.jdbc.BadSqlGrammarException: PreparedStatementCallback; bad SQL grammar [SELE','2012-10-11 18:41:00'),(3,2,'crawlerHomeTaskExecutionStep',4,'2012-10-11 18:42:00','2012-10-11 18:42:00','FAILED',0,0,0,0,0,0,0,0,'FAILED','org.springframework.batch.item.ItemStreamException: Could not move to stored position on restart\r\n	at org.springframework.batch.item.support.AbstractItemCountingItemStreamItemReader.open(AbstractItemCountingItemStreamItemReader.java:155)\r\n	at org.springframework.batch.item.database.JdbcPagingItemReader.open(JdbcPagingItemReader.java:245)\r\n	at org.springframework.batch.item.support.CompositeItemStream.open(CompositeItemStream.java:93)\r\n	at org.springframework.batch.core.step.tasklet.TaskletStep.open(TaskletStep.java:301)\r\n	at org.springframework.batch.core.step.AbstractStep.execute(AbstractStep.java:192)\r\n	at org.springframework.batch.core.job.SimpleStepHandler.handleStep(SimpleStepHandler.java:135)\r\n	at org.springframework.batch.core.job.flow.JobFlowExecutor.executeStep(JobFlowExecutor.java:61)\r\n	at org.springframework.batch.core.job.flow.support.state.StepState.handle(StepState.java:60)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.resume(SimpleFlow.java:144)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.start(SimpleFlow.java:124)\r\n	at org.springframework.batch.core.job.flow.FlowJob.doExecute(FlowJob.java:135)\r\n	at org.springframework.batch.core.job.AbstractJob.execute(AbstractJob.java:293)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher$1.run(SimpleJobLauncher.java:120)\r\n	at org.springframework.core.task.SyncTaskExecutor.execute(SyncTaskExecutor.java:48)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher.run(SimpleJobLauncher.java:114)\r\n	at com.toney.crawler.collection.jobs.CrawlerPageJobImpl.crawlerHome(CrawlerPageJobImpl.java:40)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:39)\r\n	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:25)\r\n	at java.lang.reflect.Method.invoke(Method.java:597)\r\n	at org.springframework.util.MethodInvoker.invoke(MethodInvoker.java:273)\r\n	at org.springframework.scheduling.quartz.MethodInvokingJobDetailFactoryBean$MethodInvokingJob.executeInternal(MethodInvokingJobDetailFactoryBean.java:311)\r\n	at org.springframework.scheduling.quartz.QuartzJobBean.execute(QuartzJobBean.java:113)\r\n	at org.quartz.core.JobRunShell.run(JobRunShell.java:213)\r\n	at org.quartz.simpl.SimpleThreadPool$WorkerThread.run(SimpleThreadPool.java:557)\r\nCaused by: org.springframework.jdbc.BadSqlGrammarException: PreparedStatementCallback; bad SQL grammar [SELE','2012-10-11 18:42:00'),(4,2,'crawlerHomeTaskExecutionStep',5,'2012-10-11 18:43:00','2012-10-11 18:43:00','FAILED',0,0,0,0,0,0,0,0,'FAILED','org.springframework.batch.item.ItemStreamException: Could not move to stored position on restart\r\n	at org.springframework.batch.item.support.AbstractItemCountingItemStreamItemReader.open(AbstractItemCountingItemStreamItemReader.java:155)\r\n	at org.springframework.batch.item.database.JdbcPagingItemReader.open(JdbcPagingItemReader.java:245)\r\n	at org.springframework.batch.item.support.CompositeItemStream.open(CompositeItemStream.java:93)\r\n	at org.springframework.batch.core.step.tasklet.TaskletStep.open(TaskletStep.java:301)\r\n	at org.springframework.batch.core.step.AbstractStep.execute(AbstractStep.java:192)\r\n	at org.springframework.batch.core.job.SimpleStepHandler.handleStep(SimpleStepHandler.java:135)\r\n	at org.springframework.batch.core.job.flow.JobFlowExecutor.executeStep(JobFlowExecutor.java:61)\r\n	at org.springframework.batch.core.job.flow.support.state.StepState.handle(StepState.java:60)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.resume(SimpleFlow.java:144)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.start(SimpleFlow.java:124)\r\n	at org.springframework.batch.core.job.flow.FlowJob.doExecute(FlowJob.java:135)\r\n	at org.springframework.batch.core.job.AbstractJob.execute(AbstractJob.java:293)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher$1.run(SimpleJobLauncher.java:120)\r\n	at org.springframework.core.task.SyncTaskExecutor.execute(SyncTaskExecutor.java:48)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher.run(SimpleJobLauncher.java:114)\r\n	at com.toney.crawler.collection.jobs.CrawlerPageJobImpl.crawlerHome(CrawlerPageJobImpl.java:40)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:39)\r\n	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:25)\r\n	at java.lang.reflect.Method.invoke(Method.java:597)\r\n	at org.springframework.util.MethodInvoker.invoke(MethodInvoker.java:273)\r\n	at org.springframework.scheduling.quartz.MethodInvokingJobDetailFactoryBean$MethodInvokingJob.executeInternal(MethodInvokingJobDetailFactoryBean.java:311)\r\n	at org.springframework.scheduling.quartz.QuartzJobBean.execute(QuartzJobBean.java:113)\r\n	at org.quartz.core.JobRunShell.run(JobRunShell.java:213)\r\n	at org.quartz.simpl.SimpleThreadPool$WorkerThread.run(SimpleThreadPool.java:557)\r\nCaused by: org.springframework.jdbc.BadSqlGrammarException: PreparedStatementCallback; bad SQL grammar [SELE','2012-10-11 18:43:00'),(5,2,'crawlerHomeTaskExecutionStep',6,'2012-10-11 18:44:00','2012-10-11 18:44:00','FAILED',0,0,0,0,0,0,0,0,'FAILED','org.springframework.batch.item.ItemStreamException: Could not move to stored position on restart\r\n	at org.springframework.batch.item.support.AbstractItemCountingItemStreamItemReader.open(AbstractItemCountingItemStreamItemReader.java:155)\r\n	at org.springframework.batch.item.database.JdbcPagingItemReader.open(JdbcPagingItemReader.java:245)\r\n	at org.springframework.batch.item.support.CompositeItemStream.open(CompositeItemStream.java:93)\r\n	at org.springframework.batch.core.step.tasklet.TaskletStep.open(TaskletStep.java:301)\r\n	at org.springframework.batch.core.step.AbstractStep.execute(AbstractStep.java:192)\r\n	at org.springframework.batch.core.job.SimpleStepHandler.handleStep(SimpleStepHandler.java:135)\r\n	at org.springframework.batch.core.job.flow.JobFlowExecutor.executeStep(JobFlowExecutor.java:61)\r\n	at org.springframework.batch.core.job.flow.support.state.StepState.handle(StepState.java:60)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.resume(SimpleFlow.java:144)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.start(SimpleFlow.java:124)\r\n	at org.springframework.batch.core.job.flow.FlowJob.doExecute(FlowJob.java:135)\r\n	at org.springframework.batch.core.job.AbstractJob.execute(AbstractJob.java:293)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher$1.run(SimpleJobLauncher.java:120)\r\n	at org.springframework.core.task.SyncTaskExecutor.execute(SyncTaskExecutor.java:48)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher.run(SimpleJobLauncher.java:114)\r\n	at com.toney.crawler.collection.jobs.CrawlerPageJobImpl.crawlerHome(CrawlerPageJobImpl.java:40)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:39)\r\n	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:25)\r\n	at java.lang.reflect.Method.invoke(Method.java:597)\r\n	at org.springframework.util.MethodInvoker.invoke(MethodInvoker.java:273)\r\n	at org.springframework.scheduling.quartz.MethodInvokingJobDetailFactoryBean$MethodInvokingJob.executeInternal(MethodInvokingJobDetailFactoryBean.java:311)\r\n	at org.springframework.scheduling.quartz.QuartzJobBean.execute(QuartzJobBean.java:113)\r\n	at org.quartz.core.JobRunShell.run(JobRunShell.java:213)\r\n	at org.quartz.simpl.SimpleThreadPool$WorkerThread.run(SimpleThreadPool.java:557)\r\nCaused by: org.springframework.jdbc.BadSqlGrammarException: PreparedStatementCallback; bad SQL grammar [SELE','2012-10-11 18:44:00'),(6,2,'crawlerHomeTaskExecutionStep',7,'2012-10-12 00:44:18','2012-10-12 00:44:19','FAILED',0,0,0,0,0,0,0,0,'FAILED','org.springframework.batch.item.ItemStreamException: Could not move to stored position on restart\r\n	at org.springframework.batch.item.support.AbstractItemCountingItemStreamItemReader.open(AbstractItemCountingItemStreamItemReader.java:155)\r\n	at org.springframework.batch.item.database.JdbcPagingItemReader.open(JdbcPagingItemReader.java:245)\r\n	at org.springframework.batch.item.support.CompositeItemStream.open(CompositeItemStream.java:93)\r\n	at org.springframework.batch.core.step.tasklet.TaskletStep.open(TaskletStep.java:301)\r\n	at org.springframework.batch.core.step.AbstractStep.execute(AbstractStep.java:192)\r\n	at org.springframework.batch.core.job.SimpleStepHandler.handleStep(SimpleStepHandler.java:135)\r\n	at org.springframework.batch.core.job.flow.JobFlowExecutor.executeStep(JobFlowExecutor.java:61)\r\n	at org.springframework.batch.core.job.flow.support.state.StepState.handle(StepState.java:60)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.resume(SimpleFlow.java:144)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.start(SimpleFlow.java:124)\r\n	at org.springframework.batch.core.job.flow.FlowJob.doExecute(FlowJob.java:135)\r\n	at org.springframework.batch.core.job.AbstractJob.execute(AbstractJob.java:293)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher$1.run(SimpleJobLauncher.java:120)\r\n	at org.springframework.core.task.SyncTaskExecutor.execute(SyncTaskExecutor.java:48)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher.run(SimpleJobLauncher.java:114)\r\n	at com.toney.crawler.collection.jobs.CrawlerPageJobImpl.crawlerHome(CrawlerPageJobImpl.java:40)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:39)\r\n	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:25)\r\n	at java.lang.reflect.Method.invoke(Method.java:597)\r\n	at org.springframework.util.MethodInvoker.invoke(MethodInvoker.java:273)\r\n	at org.springframework.scheduling.quartz.MethodInvokingJobDetailFactoryBean$MethodInvokingJob.executeInternal(MethodInvokingJobDetailFactoryBean.java:311)\r\n	at org.springframework.scheduling.quartz.QuartzJobBean.execute(QuartzJobBean.java:113)\r\n	at org.quartz.core.JobRunShell.run(JobRunShell.java:213)\r\n	at org.quartz.simpl.SimpleThreadPool$WorkerThread.run(SimpleThreadPool.java:557)\r\nCaused by: org.springframework.jdbc.BadSqlGrammarException: PreparedStatementCallback; bad SQL grammar [SELE','2012-10-12 00:44:19'),(7,2,'crawlerHomeTaskExecutionStep',8,'2012-10-12 08:59:45','2012-10-12 08:59:48','FAILED',0,0,0,0,0,0,0,0,'FAILED','org.springframework.batch.item.ItemStreamException: Could not move to stored position on restart\r\n	at org.springframework.batch.item.support.AbstractItemCountingItemStreamItemReader.open(AbstractItemCountingItemStreamItemReader.java:155)\r\n	at org.springframework.batch.item.database.JdbcPagingItemReader.open(JdbcPagingItemReader.java:245)\r\n	at org.springframework.batch.item.support.CompositeItemStream.open(CompositeItemStream.java:93)\r\n	at org.springframework.batch.core.step.tasklet.TaskletStep.open(TaskletStep.java:301)\r\n	at org.springframework.batch.core.step.AbstractStep.execute(AbstractStep.java:192)\r\n	at org.springframework.batch.core.job.SimpleStepHandler.handleStep(SimpleStepHandler.java:135)\r\n	at org.springframework.batch.core.job.flow.JobFlowExecutor.executeStep(JobFlowExecutor.java:61)\r\n	at org.springframework.batch.core.job.flow.support.state.StepState.handle(StepState.java:60)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.resume(SimpleFlow.java:144)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.start(SimpleFlow.java:124)\r\n	at org.springframework.batch.core.job.flow.FlowJob.doExecute(FlowJob.java:135)\r\n	at org.springframework.batch.core.job.AbstractJob.execute(AbstractJob.java:293)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher$1.run(SimpleJobLauncher.java:120)\r\n	at org.springframework.core.task.SyncTaskExecutor.execute(SyncTaskExecutor.java:48)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher.run(SimpleJobLauncher.java:114)\r\n	at com.toney.crawler.collection.jobs.CrawlerPageJobImpl.crawlerHome(CrawlerPageJobImpl.java:40)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:39)\r\n	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:25)\r\n	at java.lang.reflect.Method.invoke(Method.java:597)\r\n	at org.springframework.util.MethodInvoker.invoke(MethodInvoker.java:273)\r\n	at org.springframework.scheduling.quartz.MethodInvokingJobDetailFactoryBean$MethodInvokingJob.executeInternal(MethodInvokingJobDetailFactoryBean.java:311)\r\n	at org.springframework.scheduling.quartz.QuartzJobBean.execute(QuartzJobBean.java:113)\r\n	at org.quartz.core.JobRunShell.run(JobRunShell.java:213)\r\n	at org.quartz.simpl.SimpleThreadPool$WorkerThread.run(SimpleThreadPool.java:557)\r\nCaused by: org.springframework.jdbc.BadSqlGrammarException: PreparedStatementCallback; bad SQL grammar [SELE','2012-10-12 08:59:48'),(8,2,'crawlerHomeTaskExecutionStep',9,'2012-10-12 08:59:52','2012-10-12 08:59:53','FAILED',0,0,0,0,0,0,0,0,'FAILED','org.springframework.batch.item.ItemStreamException: Could not move to stored position on restart\r\n	at org.springframework.batch.item.support.AbstractItemCountingItemStreamItemReader.open(AbstractItemCountingItemStreamItemReader.java:155)\r\n	at org.springframework.batch.item.database.JdbcPagingItemReader.open(JdbcPagingItemReader.java:245)\r\n	at org.springframework.batch.item.support.CompositeItemStream.open(CompositeItemStream.java:93)\r\n	at org.springframework.batch.core.step.tasklet.TaskletStep.open(TaskletStep.java:301)\r\n	at org.springframework.batch.core.step.AbstractStep.execute(AbstractStep.java:192)\r\n	at org.springframework.batch.core.job.SimpleStepHandler.handleStep(SimpleStepHandler.java:135)\r\n	at org.springframework.batch.core.job.flow.JobFlowExecutor.executeStep(JobFlowExecutor.java:61)\r\n	at org.springframework.batch.core.job.flow.support.state.StepState.handle(StepState.java:60)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.resume(SimpleFlow.java:144)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.start(SimpleFlow.java:124)\r\n	at org.springframework.batch.core.job.flow.FlowJob.doExecute(FlowJob.java:135)\r\n	at org.springframework.batch.core.job.AbstractJob.execute(AbstractJob.java:293)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher$1.run(SimpleJobLauncher.java:120)\r\n	at org.springframework.core.task.SyncTaskExecutor.execute(SyncTaskExecutor.java:48)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher.run(SimpleJobLauncher.java:114)\r\n	at com.toney.crawler.collection.jobs.CrawlerPageJobImpl.crawlerHome(CrawlerPageJobImpl.java:40)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:39)\r\n	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:25)\r\n	at java.lang.reflect.Method.invoke(Method.java:597)\r\n	at org.springframework.util.MethodInvoker.invoke(MethodInvoker.java:273)\r\n	at org.springframework.scheduling.quartz.MethodInvokingJobDetailFactoryBean$MethodInvokingJob.executeInternal(MethodInvokingJobDetailFactoryBean.java:311)\r\n	at org.springframework.scheduling.quartz.QuartzJobBean.execute(QuartzJobBean.java:113)\r\n	at org.quartz.core.JobRunShell.run(JobRunShell.java:213)\r\n	at org.quartz.simpl.SimpleThreadPool$WorkerThread.run(SimpleThreadPool.java:557)\r\nCaused by: org.springframework.jdbc.BadSqlGrammarException: PreparedStatementCallback; bad SQL grammar [SELE','2012-10-12 08:59:53'),(9,2,'crawlerHomeTaskExecutionStep',10,'2012-10-12 09:00:00','2012-10-12 09:00:00','FAILED',0,0,0,0,0,0,0,0,'FAILED','org.springframework.batch.item.ItemStreamException: Could not move to stored position on restart\r\n	at org.springframework.batch.item.support.AbstractItemCountingItemStreamItemReader.open(AbstractItemCountingItemStreamItemReader.java:155)\r\n	at org.springframework.batch.item.database.JdbcPagingItemReader.open(JdbcPagingItemReader.java:245)\r\n	at org.springframework.batch.item.support.CompositeItemStream.open(CompositeItemStream.java:93)\r\n	at org.springframework.batch.core.step.tasklet.TaskletStep.open(TaskletStep.java:301)\r\n	at org.springframework.batch.core.step.AbstractStep.execute(AbstractStep.java:192)\r\n	at org.springframework.batch.core.job.SimpleStepHandler.handleStep(SimpleStepHandler.java:135)\r\n	at org.springframework.batch.core.job.flow.JobFlowExecutor.executeStep(JobFlowExecutor.java:61)\r\n	at org.springframework.batch.core.job.flow.support.state.StepState.handle(StepState.java:60)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.resume(SimpleFlow.java:144)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.start(SimpleFlow.java:124)\r\n	at org.springframework.batch.core.job.flow.FlowJob.doExecute(FlowJob.java:135)\r\n	at org.springframework.batch.core.job.AbstractJob.execute(AbstractJob.java:293)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher$1.run(SimpleJobLauncher.java:120)\r\n	at org.springframework.core.task.SyncTaskExecutor.execute(SyncTaskExecutor.java:48)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher.run(SimpleJobLauncher.java:114)\r\n	at com.toney.crawler.collection.jobs.CrawlerPageJobImpl.crawlerHome(CrawlerPageJobImpl.java:40)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:39)\r\n	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:25)\r\n	at java.lang.reflect.Method.invoke(Method.java:597)\r\n	at org.springframework.util.MethodInvoker.invoke(MethodInvoker.java:273)\r\n	at org.springframework.scheduling.quartz.MethodInvokingJobDetailFactoryBean$MethodInvokingJob.executeInternal(MethodInvokingJobDetailFactoryBean.java:311)\r\n	at org.springframework.scheduling.quartz.QuartzJobBean.execute(QuartzJobBean.java:113)\r\n	at org.quartz.core.JobRunShell.run(JobRunShell.java:213)\r\n	at org.quartz.simpl.SimpleThreadPool$WorkerThread.run(SimpleThreadPool.java:557)\r\nCaused by: org.springframework.jdbc.BadSqlGrammarException: PreparedStatementCallback; bad SQL grammar [SELE','2012-10-12 09:00:00'),(10,2,'crawlerHomeTaskExecutionStep',11,'2012-10-12 09:01:00','2012-10-12 09:01:00','FAILED',0,0,0,0,0,0,0,0,'FAILED','org.springframework.batch.item.ItemStreamException: Could not move to stored position on restart\r\n	at org.springframework.batch.item.support.AbstractItemCountingItemStreamItemReader.open(AbstractItemCountingItemStreamItemReader.java:155)\r\n	at org.springframework.batch.item.database.JdbcPagingItemReader.open(JdbcPagingItemReader.java:245)\r\n	at org.springframework.batch.item.support.CompositeItemStream.open(CompositeItemStream.java:93)\r\n	at org.springframework.batch.core.step.tasklet.TaskletStep.open(TaskletStep.java:301)\r\n	at org.springframework.batch.core.step.AbstractStep.execute(AbstractStep.java:192)\r\n	at org.springframework.batch.core.job.SimpleStepHandler.handleStep(SimpleStepHandler.java:135)\r\n	at org.springframework.batch.core.job.flow.JobFlowExecutor.executeStep(JobFlowExecutor.java:61)\r\n	at org.springframework.batch.core.job.flow.support.state.StepState.handle(StepState.java:60)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.resume(SimpleFlow.java:144)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.start(SimpleFlow.java:124)\r\n	at org.springframework.batch.core.job.flow.FlowJob.doExecute(FlowJob.java:135)\r\n	at org.springframework.batch.core.job.AbstractJob.execute(AbstractJob.java:293)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher$1.run(SimpleJobLauncher.java:120)\r\n	at org.springframework.core.task.SyncTaskExecutor.execute(SyncTaskExecutor.java:48)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher.run(SimpleJobLauncher.java:114)\r\n	at com.toney.crawler.collection.jobs.CrawlerPageJobImpl.crawlerHome(CrawlerPageJobImpl.java:40)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:39)\r\n	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:25)\r\n	at java.lang.reflect.Method.invoke(Method.java:597)\r\n	at org.springframework.util.MethodInvoker.invoke(MethodInvoker.java:273)\r\n	at org.springframework.scheduling.quartz.MethodInvokingJobDetailFactoryBean$MethodInvokingJob.executeInternal(MethodInvokingJobDetailFactoryBean.java:311)\r\n	at org.springframework.scheduling.quartz.QuartzJobBean.execute(QuartzJobBean.java:113)\r\n	at org.quartz.core.JobRunShell.run(JobRunShell.java:213)\r\n	at org.quartz.simpl.SimpleThreadPool$WorkerThread.run(SimpleThreadPool.java:557)\r\nCaused by: org.springframework.jdbc.BadSqlGrammarException: PreparedStatementCallback; bad SQL grammar [SELE','2012-10-12 09:01:00'),(11,2,'crawlerHomeTaskExecutionStep',12,'2012-10-12 09:02:00','2012-10-12 09:02:00','FAILED',0,0,0,0,0,0,0,0,'FAILED','org.springframework.batch.item.ItemStreamException: Could not move to stored position on restart\r\n	at org.springframework.batch.item.support.AbstractItemCountingItemStreamItemReader.open(AbstractItemCountingItemStreamItemReader.java:155)\r\n	at org.springframework.batch.item.database.JdbcPagingItemReader.open(JdbcPagingItemReader.java:245)\r\n	at org.springframework.batch.item.support.CompositeItemStream.open(CompositeItemStream.java:93)\r\n	at org.springframework.batch.core.step.tasklet.TaskletStep.open(TaskletStep.java:301)\r\n	at org.springframework.batch.core.step.AbstractStep.execute(AbstractStep.java:192)\r\n	at org.springframework.batch.core.job.SimpleStepHandler.handleStep(SimpleStepHandler.java:135)\r\n	at org.springframework.batch.core.job.flow.JobFlowExecutor.executeStep(JobFlowExecutor.java:61)\r\n	at org.springframework.batch.core.job.flow.support.state.StepState.handle(StepState.java:60)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.resume(SimpleFlow.java:144)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.start(SimpleFlow.java:124)\r\n	at org.springframework.batch.core.job.flow.FlowJob.doExecute(FlowJob.java:135)\r\n	at org.springframework.batch.core.job.AbstractJob.execute(AbstractJob.java:293)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher$1.run(SimpleJobLauncher.java:120)\r\n	at org.springframework.core.task.SyncTaskExecutor.execute(SyncTaskExecutor.java:48)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher.run(SimpleJobLauncher.java:114)\r\n	at com.toney.crawler.collection.jobs.CrawlerPageJobImpl.crawlerHome(CrawlerPageJobImpl.java:40)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:39)\r\n	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:25)\r\n	at java.lang.reflect.Method.invoke(Method.java:597)\r\n	at org.springframework.util.MethodInvoker.invoke(MethodInvoker.java:273)\r\n	at org.springframework.scheduling.quartz.MethodInvokingJobDetailFactoryBean$MethodInvokingJob.executeInternal(MethodInvokingJobDetailFactoryBean.java:311)\r\n	at org.springframework.scheduling.quartz.QuartzJobBean.execute(QuartzJobBean.java:113)\r\n	at org.quartz.core.JobRunShell.run(JobRunShell.java:213)\r\n	at org.quartz.simpl.SimpleThreadPool$WorkerThread.run(SimpleThreadPool.java:557)\r\nCaused by: org.springframework.jdbc.BadSqlGrammarException: PreparedStatementCallback; bad SQL grammar [SELE','2012-10-12 09:02:00'),(12,2,'crawlerHomeTaskExecutionStep',13,'2012-10-12 09:03:00','2012-10-12 09:03:00','FAILED',0,0,0,0,0,0,0,0,'FAILED','org.springframework.batch.item.ItemStreamException: Could not move to stored position on restart\r\n	at org.springframework.batch.item.support.AbstractItemCountingItemStreamItemReader.open(AbstractItemCountingItemStreamItemReader.java:155)\r\n	at org.springframework.batch.item.database.JdbcPagingItemReader.open(JdbcPagingItemReader.java:245)\r\n	at org.springframework.batch.item.support.CompositeItemStream.open(CompositeItemStream.java:93)\r\n	at org.springframework.batch.core.step.tasklet.TaskletStep.open(TaskletStep.java:301)\r\n	at org.springframework.batch.core.step.AbstractStep.execute(AbstractStep.java:192)\r\n	at org.springframework.batch.core.job.SimpleStepHandler.handleStep(SimpleStepHandler.java:135)\r\n	at org.springframework.batch.core.job.flow.JobFlowExecutor.executeStep(JobFlowExecutor.java:61)\r\n	at org.springframework.batch.core.job.flow.support.state.StepState.handle(StepState.java:60)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.resume(SimpleFlow.java:144)\r\n	at org.springframework.batch.core.job.flow.support.SimpleFlow.start(SimpleFlow.java:124)\r\n	at org.springframework.batch.core.job.flow.FlowJob.doExecute(FlowJob.java:135)\r\n	at org.springframework.batch.core.job.AbstractJob.execute(AbstractJob.java:293)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher$1.run(SimpleJobLauncher.java:120)\r\n	at org.springframework.core.task.SyncTaskExecutor.execute(SyncTaskExecutor.java:48)\r\n	at org.springframework.batch.core.launch.support.SimpleJobLauncher.run(SimpleJobLauncher.java:114)\r\n	at com.toney.crawler.collection.jobs.CrawlerPageJobImpl.crawlerHome(CrawlerPageJobImpl.java:40)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)\r\n	at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:39)\r\n	at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:25)\r\n	at java.lang.reflect.Method.invoke(Method.java:597)\r\n	at org.springframework.util.MethodInvoker.invoke(MethodInvoker.java:273)\r\n	at org.springframework.scheduling.quartz.MethodInvokingJobDetailFactoryBean$MethodInvokingJob.executeInternal(MethodInvokingJobDetailFactoryBean.java:311)\r\n	at org.springframework.scheduling.quartz.QuartzJobBean.execute(QuartzJobBean.java:113)\r\n	at org.quartz.core.JobRunShell.run(JobRunShell.java:213)\r\n	at org.quartz.simpl.SimpleThreadPool$WorkerThread.run(SimpleThreadPool.java:557)\r\nCaused by: org.springframework.jdbc.BadSqlGrammarException: PreparedStatementCallback; bad SQL grammar [SELE','2012-10-12 09:03:00');
...
insert  into `batch_step_execution_context`(`STEP_EXECUTION_ID`,`SHORT_CONTEXT`,`SERIALIZED_CONTEXT`) values (1,'{\"map\":{\"entry\":{\"string\":\"JdbcPagingItemReader.read.count\",\"int\":4}}}',NULL),(2,'{\"map\":{\"entry\":{\"string\":\"JdbcPagingItemReader.read.count\",\"int\":4}}}',NULL),(3,'{\"map\":{\"entry\":{\"string\":\"JdbcPagingItemReader.read.count\",\"int\":4}}}',NULL),(4,'{\"map\":{\"entry\":{\"string\":\"JdbcPagingItemReader.read.count\",\"int\":4}}}',NULL),(5,'{\"map\":{\"entry\":{\"string\":\"JdbcPagingItemReader.read.count\",\"int\":4}}}',NULL),(6,'{\"map\":{\"entry\":{\"string\":\"JdbcPagingItemReader.read.count\",\"int\":4}}}',NULL),(7,'{\"map\":{\"entry\":{\"string\":\"JdbcPagingItemReader.read.count\",\"int\":4}}}',NULL),(8,'{\"map\":{\"entry\":{\"string\":\"JdbcPagingItemReader.read.count\",\"int\":4}}}',NULL),(9,'{\"map\":{\"entry\":{\"string\":\"JdbcPagingItemReader.read.count\",\"int\":4}}}',NULL),(10,'{\"map\":{\"entry\":{\"string\":\"JdbcPagingItemReader.read.count\",\"int\":4}}}',NULL),(11,'{\"map\":{\"entry\":{\"string\":\"JdbcPagingItemReader.read.count\",\"int\":4}}}',NULL),(12,'{\"map\":{\"entry\":{\"string\":\"JdbcPagingItemReader.read.count\",\"int\":4}}}',NULL);
...
insert  into `batch_step_execution_seq`(`ID`) values (12);
...
insert  into `dede_addonarticle`(`aid`,`typeid`,`body`,`redirecturl`,`templet`,`userip`) values (1,1,'adfasfasdfasdf asdfas dfasdf&nbsp;','','','127.0.0.1');
...
insert  into `dede_admin`(`id`,`usertype`,`userid`,`pwd`,`uname`,`tname`,`email`,`typeid`,`logintime`,`loginip`) values (1,10,'admin','21232f297a57a5a743894a0e4a801fc3','admin','','','0',1343621229,'127.0.0.1'),(2,10,'adminadmin','f297a57a5a743894a0e4','adminadmin','','',NULL,1344611767,'127.0.0.1');
...
/*Table structure for table `dede_appconfigs` */

DROP TABLE IF EXISTS `dede_appconfigs`;

CREATE TABLE `dede_appconfigs` (
  `id` tinyint(8) unsigned NOT NULL DEFAULT '0',
  `cfg_name` varchar(20) NOT NULL,
  `cfg_key` varchar(20) NOT NULL,
  `cfg_value` varchar(255) NOT NULL,
  `description` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `dede_appconfigs` */

insert  into `dede_appconfigs`(`id`,`cfg_name`,`cfg_key`,`cfg_value`,`description`) values (1,'global','url.static_url','http://images.toney.com/static','静态资源路径');
...
insert  into `dede_arccache`(`md5hash`,`uptime`,`cachedata`) values ('38acf1657dca6c4289c78e3745139a6f',1342602226,'0'),('7300ae7054acf53687580e6975e0e4f4',1342602226,'1');
...
insert  into `dede_archives`(`id`,`typeid`,`typeid2`,`sortrank`,`flag`,`ismake`,`channel`,`arcrank`,`click`,`money`,`title`,`shorttitle`,`color`,`writer`,`source`,`litpic`,`pubdate`,`senddate`,`mid`,`keywords`,`lastpost`,`scores`,`goodpost`,`badpost`,`voteid`,`notpost`,`description`,`filename`,`dutyadmin`,`tackid`,`mtype`,`weight`) values (1,1,'0',1342602147,'',1,1,0,104,0,'啊发放爱的色放阿斯蒂芬阿德法','','','admin','未知','',1342602147,1342602157,1,'啊,发放,爱的,色放,阿,斯蒂芬,德法,',1342602782,-2,0,1,0,0,'adfasfasdfasdf asdfas dfasdf','',1,0,0,0);
...
insert  into `dede_arcmulti`(`id`,`tagid`,`uptime`,`innertext`,`pagesize`,`arcids`,`ordersql`,`addfieldsSql`,`addfieldsSqlJoin`,`attstr`) values (1,'dedecms',1343119677,'<li class=\'dotline\'><a href=\"[field:arcurl/]\">[field:title/]</a></li>',8,'',' ORDER BY arc.sortrank desc','','','a:16:{s:3:\"row\";s:2:\"16\";s:8:\"titlelen\";s:2:\"42\";s:7:\"infolen\";i:160;s:8:\"imgwidth\";i:120;s:9:\"imgheight\";i:120;s:8:\"listtype\";s:3:\"all\";s:5:\"arcid\";i:0;s:9:\"channelid\";i:0;s:7:\"orderby\";s:7:\"default\";s:8:\"orderWay\";s:4:\"desc\";s:6:\"subday\";i:0;s:8:\"pagesize\";s:1:\"8\";s:7:\"keyword\";s:0:\"\";s:10:\"tablewidth\";s:4:\"100%\";s:3:\"col\";i:1;s:8:\"colWidth\";s:4:\"100%\";}');
...
insert  into `dede_arctiny`(`id`,`typeid`,`typeid2`,`arcrank`,`channel`,`senddate`,`sortrank`,`mid`) values (1,1,'0',0,1,1342602157,1342602147,1);
...
insert  into `dede_arctype`(`id`,`reid`,`topid`,`sortrank`,`typename`,`typedir`,`isdefault`,`defaultname`,`issend`,`channeltype`,`maxpage`,`ispart`,`corank`,`tempindex`,`templist`,`temparticle`,`namerule`,`namerule2`,`modname`,`description`,`keywords`,`seotitle`,`moresite`,`sitepath`,`siteurl`,`ishidden`,`cross`,`crossid`,`content`,`smalltypes`) values (1,0,0,50,'测试1','/a/ceshi1',1,'index.html',1,1,-1,0,0,'{style}/index_article.htm','{style}/list_article.htm','{style}/article_article.htm','{typedir}/{Y}/{M}{D}/{aid}.html','{typedir}/list_{tid}_{page}.html','','','','',0,'','',0,0,'','',''),(2,1,1,50,'a1','/a/ceshi1/a1',1,'index.html',1,1,-1,0,0,'{style}/index_article.htm','{style}/list_article-1.htm','{style}/article_article.htm','{typedir}/{Y}/{M}{D}/{aid}.html','{typedir}/list_{tid}_{page}.html','','','','',0,'','',0,0,'','&nbsp;',''),(3,2,1,50,'a11','/a/ceshi1/a1/a11',0,'index.html',1,1,-1,0,0,'{style}/index_article.htm','{style}/list_article.htm','{style}/article_article.htm','{typedir}/{Y}/{M}{D}/{aid}.html','{typedir}/list_{tid}_{page}.html','','','','',0,'','',0,0,'','&nbsp;',''),(4,0,0,50,'a2','/a/a2',1,'index.html',1,1,-1,0,0,'{style}/index_article.htm','{style}/list_article.htm','{style}/article_article.htm','{typedir}/{Y}/{M}{D}/{aid}.html','{typedir}/list_{tid}_{page}.html','','','','',0,'','',0,0,'','',''),(5,2,1,23,'a12','/a/ceshi1/a1/a12',1,'index.html',1,1,-1,0,0,'{style}/index_article.htm','{style}/list_article.htm','{style}/article_article.htm','{typedir}/{Y}/{M}{D}/{aid}.html','{typedir}/list_{tid}_{page}.html','','','','',0,'','',0,0,'','&nbsp;','');
...
/*Table structure for table `dede_crawler_dttask` */

DROP TABLE IF EXISTS `dede_crawler_dttask`;

CREATE TABLE `dede_crawler_dttask` (
  `cdid` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `clid` mediumint(9) NOT NULL,
...
/*Data for the table `dede_crawler_dttask` */

/*Table structure for table `dede_crawler_dttask_log` */

DROP TABLE IF EXISTS `dede_crawler_dttask_log`;

CREATE TABLE `dede_crawler_dttask_log` (
...
/*Data for the table `dede_crawler_dttask_log` */

/*Table structure for table `dede_crawler_listtask` */

DROP TABLE IF EXISTS `dede_crawler_listtask`;

CREATE TABLE `dede_crawler_listtask` (
  `clid` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `dede_crawler_listtask` */

/*Table structure for table `dede_crawler_listtask_log` */

DROP TABLE IF EXISTS `dede_crawler_listtask_log`;

CREATE TABLE `dede_crawler_listtask_log` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `dede_crawler_listtask_log` */

/*Table structure for table `dede_crawler_task` */

DROP TABLE IF EXISTS `dede_crawler_task`;

CREATE TABLE `dede_crawler_task` (
  `cid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `sitename` varchar(50) NOT NULL DEFAULT '',
  `url` varchar(200) NOT NULL DEFAULT '',
  `description` varchar(150) NOT NULL DEFAULT '',
  `createdate` int(10) NOT NULL DEFAULT '0',
  `listwords` varchar(100) NOT NULL DEFAULT '',
  `stopwords` varchar(100) NOT NULL DEFAULT '1',
  `isenable` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`cid`),
  UNIQUE KEY `url` (`url`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `dede_crawler_task` */

/*Table structure for table `dede_crawler_task_log` */

DROP TABLE IF EXISTS `dede_crawler_task_log`;

CREATE TABLE `dede_crawler_task_log` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `cid` mediumint(9) NOT NULL,
  `title` varchar(150) NOT NULL DEFAULT '',
  `createdate` int(10) NOT NULL DEFAULT '0',
...
/*Data for the table `dede_crawler_task_log` */

/*Table structure for table `dede_crawler_xml` */

DROP TABLE IF EXISTS `dede_crawler_xml`;

CREATE TABLE `dede_crawler_xml` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `cid` mediumint(9) NOT NULL,
  `type` varchar(10) NOT NULL DEFAULT '',
  `createdate` int(10) NOT NULL DEFAULT '0',
  `crawlerxml` mediumtext NOT NULL,
  `isenable` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `cid` (`cid`,`type`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `dede_crawler_xml` */
...
insert  into `dede_homepageset`(`templet`,`position`,`showmod`) values ('default/index.htm','../index.html',1);
...
insert  into `dede_member`(`mid`,`mtype`,`userid`,`pwd`,`uname`,`sex`,`rank`,`uptime`,`exptime`,`money`,`email`,`scores`,`matt`,`spacesta`,`face`,`safequestion`,`safeanswer`,`jointime`,`joinip`,`logintime`,`loginip`,`checkmail`) values (1,'个人','admin','21232f297a57a5a743894a0e4a801fc3','admin','男',100,0,0,0,'',10000,10,0,'',0,'',1342599040,'',1343621229,'127.0.0.1',-1);
...
insert  into `dede_member_tj`(`mid`,`article`,`album`,`archives`,`homecount`,`pagecount`,`feedback`,`friend`,`stow`,`soft`,`info`,`shop`) values (1,0,0,0,0,4,0,0,0,0,0,0);
...
insert  into `dede_search_keywords`(`aid`,`keyword`,`spwords`,`count`,`result`,`lasttime`,`channelid`,`typeid`) values (1,'啊','啊',1,1,1342602774,0,0);
...
/*Table structure for table `dede_templage_manager` */

DROP TABLE IF EXISTS `dede_templage_manager`;

CREATE TABLE `dede_templage_manager` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `createdate` int(10) NOT NULL DEFAULT '0',
  `publishpath` varchar(50) NOT NULL DEFAULT '',
  `value` varchar(200) NOT NULL DEFAULT '',
  `isenable` tinyint(6) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `groupid` (`groupid`,`templatename`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

/*Data for the table `dede_templage_manager` */

insert  into `dede_templage_manager`(`id`,`templatename`,`groupid`,`groupname`,`description`,`createdate`,`publishpath`,`value`,`isenable`) values (4,'public_head_head',1,'public','页头head部分',1348732198,'/public/public_head_head','/public/public_head_head',1),(5,'public_head_nav',1,'public','页头导航部分',1348738305,'/public/public_head_nav','/public/public_head_nav',1),(6,'public_footer_js',1,'public','页尾js部分',1348738477,'/public/public_footer_js','/public/public_footer_js',1),(7,'public_footer_cpr',1,'public','页尾版权、免责声明等部分',1348738477,'/public/public_footer_cpr','/public/public_footer_cpr',1),(8,'public_footer_index',1,'public','页尾友情链接等部分，只首页需要',1348738477,'/public/public_footer_index','/public/public_footer_index',1);
