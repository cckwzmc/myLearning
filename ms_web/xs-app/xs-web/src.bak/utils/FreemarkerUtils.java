package com.toney.mvc.tpl.utils;
...
import com.toney.mvc.tpl.exception.MustBooleanException;
import com.toney.mvc.tpl.exception.MustDateException;
import com.toney.mvc.tpl.exception.MustNumberException;
import com.toney.mvc.tpl.exception.MustSplitNumberException;
import com.toney.mvc.tpl.exception.MustStringException;
...
/**
 * @author toney.li freemarker 工具类
 */
public class FreemarkerUtils {
	...
	public static Map<String, TemplateModel> addParamsToVariable(Environment env, Map<String, TemplateModel> params)
			throws TemplateException {
		Map<String, TemplateModel> resultMap = new HashMap<String, TemplateModel>();
	...
	/**
	 * 将variable中的params值用origMap中的值替换。
	 * 
	 * @param env
	 * @param params
	 * @param origMap
	...
	public static Integer[] getIntArray(String name, Map<String, TemplateModel> params) throws TemplateException {
		String str = FreemarkerUtils.getString(name, params);
	...
	public static Date getDate(String name, Map<String, TemplateModel> params) throws TemplateException {
		...
		if (model instanceof TemplateDateModel) {
			...
			return FreemarkerUtils.getLongDateStr(((TemplateScalarModel) model).getAsString());
		} else {
	...
	public static Date getLongDateStr(String text) throws IllegalArgumentException {
		final DateFormat DF_LONG = new SimpleDateFormat(
				"yyyy-MM-dd HH:mm:ss");
