...
public class CommonsConfigurationFactoryBean implements InitializingBean, FactoryBean<Properties> {
    ...
    /**
     * Shortcut for loading configuration from Spring resources. It will internally create a PropertiesConfiguration
     * object based on the URL retrieved from the given Resources.
     * 
     * @param locations
     */
