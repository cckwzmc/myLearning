 ...
 * 
 */
@ContextConfiguration(locations = { "classpath:/applicationContext-publish-beans.xml" })
public abstract class BasePublishManagerTestCase extends AbstractTransactionalJUnit4SpringContextTests {

    /**
     * A simple logger
     */
    protected static final Logger LOGGER = LoggerFactory.getLogger(BasePublishManagerTestCase.class);
    /**
     * The resourceBundle
     */
     ...
     */
    public BasePublishManagerTestCase() {
