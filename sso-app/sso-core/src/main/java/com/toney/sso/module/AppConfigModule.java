 ...
 **************************************************************** 
 */
public class AppConfigModule extends BaseObject {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8099121661985048271L;
	private Long id;
	...
	public String toString() {
		return "AppConfigModule [id=" + id + ", groupCode=" + groupCode + ", enabled=" + enabled + ", cfgKey=" + cfgKey + ", cfgValues=" + cfgValues + ", createDate=" + createDate
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AppConfigModule other = (AppConfigModule) obj;
