...
<m:top item='1_' name='常用操作' display='block'>
  ...
  <m:item name='书籍列表管理' link='content_list.php?type=book' rank='a_List,a_AccList' target='main' />
...
<m:top item='5_' name='HTML更新' notshowall='1' display='none' rank='sys_MakeHtml'>
  ...
  <m:item name='更新栏目HTML（都可使用）' link='makehtml_list.php' rank='sys_MakeHtml' target='main' />
  <m:item name='更新小说封面HTML' link='makehtml_list_xs_page.php' rank='sys_MakeHtml' target='main' />
  <m:item name='更新小说目录HTML' link='makehtml_list_xs_table.php' rank='sys_MakeHtml' target='main' />
