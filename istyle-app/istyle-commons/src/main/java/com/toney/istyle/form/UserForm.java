...
public class UserForm extends BaseObject {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2200217381264327166L;
	private Long id;
	...
	public String toString() {
		return "UserForm [id=" + id + ", userName=" + userName + ", nickName=" + nickName + ", mobile=" + mobile + ", createDate=" + createDate + ", status=" + status + "]";
	}
