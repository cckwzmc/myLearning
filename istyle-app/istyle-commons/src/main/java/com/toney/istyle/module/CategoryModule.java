...
public class CategoryModule extends BaseModule {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8412141271568845828L;
	...
	public String toString() {
		return "CategoryModule [id=" + id + ", parentId=" + parentId + ", catCode=" + catCode + ", catName=" + catName + ", createDate=" + createDate + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CategoryModule other = (CategoryModule) obj;
		if (catCode == null) {
