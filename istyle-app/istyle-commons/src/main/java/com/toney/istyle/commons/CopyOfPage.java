...
public class CopyOfPage<T> {
	...
	public int getPreMorePage() {
		return preMorePage;
	}

	public void setPreMorePage(int preMorePage) {
		this.preMorePage = preMorePage;
	}
	...
	public void setShowMinPage(int showMinPage) {
		this.showMinPage = showMinPage;
	}
	...
	public void setHasPre(boolean isHasPre) {
	...
	// 排序使用.
	// protected List<Map<String, String>> orderBy = new ArrayList<Map<String,
	// String>>();
	// 返回结果
	...
	public String toString() {
		return "Page [pageNo=" + pageNo + ", pageSize=" + pageSize + ", totalCount=" + totalCount + ", totalPages=" + totalPages + ", morePage=" + morePage + ", preMorePage="
				+ preMorePage + ", showMinPage=" + showMinPage + ", showMaxPage=" + showMaxPage + ", result=" + result + ", isHasNext=" + isHasNext + ", isHasPre=" + isHasPre
