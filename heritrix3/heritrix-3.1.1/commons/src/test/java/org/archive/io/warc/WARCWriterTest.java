...
//    }
    ...
    public void testWarcRecordReads() throws Exception{
    	// Get reader on said ARC.
    	File file=new File("/home/toney.li/works-tools/heritrix-3.1.1/jobs/meishichina/20121129165906/warcs/WEB-20121129170126668-00000-9440~toney-fd-pc~8443.warc.gz");
		WARCReader r = WARCReaderFactory.get(file);
		final Iterator<ArchiveRecord> i = r.iterator();
		// Skip first ARC meta record.
		ArchiveRecord ar = i.next();
		i.hasNext();
